...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO product (admin_id, name, category, brand, price, quantity, condition, material, description, sku, upc, color, low_threshold, normal_threshold) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        $stmt->execute([$admin_id, $name, $category, $brand, $price, $quantity, $condition, $material, $description, $sku, $upc, $color, $low_threshold, $normal_threshold]);
                ...
                <div class="row mt-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control" id="inventory-qty" name="inventory-qty"
                            placeholder="Enter inventory qty" oninput="updateStatus()">
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control" id="normal-threshold" name="normal-threshold"
                            placeholder="Enter normal threshold qty" oninput="updateStatus()">
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control" id="low-threshold" name="low-threshold"
                            placeholder="Enter low threshold qty" oninput="updateStatus()">
                    </div>
                    <div class="col-md-3">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content p-3">
            <div class="modal-header justify-content-center pb-1" style="border-bottom: none;">
                <h5 class="modal-title text-success text-center fs-3 fw-light" id="confirmModalLabel">CONFIRM PRODUCT
                    DETAILS?</h5>
            </div>

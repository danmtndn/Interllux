...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        if (!empty($image_url)) {
            $image_stmt = $pdo->prepare("INSERT INTO img (product_id, img_path) VALUES (?, ?) ON CONFLICT (product_id) DO UPDATE SET img_path = EXCLUDED.img_path");
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <input type="url" class="form-control" id="image-url" name="image-url"
                            value="<?php echo $image ? $image['img_path'] : ''; ?>">
                    </div>
                </div>
